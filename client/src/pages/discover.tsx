        ...
        <div className="mt-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[300px_1fr] gap-6">
            ...
            <div>
              <Card>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    >
                      <ToggleGroupItem value="all" aria-label="All Opportunities" className="flex-1 text-xs">
                        <Filter className="h-3 w-3 mr-1" />
                        All
                      </ToggleGroupItem>
                      <ToggleGroupItem value="individual" aria-label="Individual Opportunities" className="flex-1 text-xs">
                        <Music className="h-3 w-3 mr-1" />
                        Individual
                      </ToggleGroupItem>
                      <ToggleGroupItem value="tours" aria-label="Tour Opportunities" className="flex-1 text-xs">
              ...
              {/* Selected Tour sidebar if a tour is selected */}
              {selectedTour && (
                <Card className="mt-4">
                  <CardHeader className="pb-3">
